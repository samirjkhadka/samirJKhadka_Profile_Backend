...
softwareApplicationRouter.post("/addApplication", isAuthenticated, addNewApplication);
softwareApplicationRouter.delete("/deleteApplication/:id", isAuthenticated, deleteApplication);
